...
!(function(e, t, n, r, o, i, a) {
  !(function(e, t, n) {
    var r = t + ' Iterator';
    (e.prototype = St(At, { next: v(1, n) })), Tt(e, r, !1), (Et[r] = jt);
  })(n, t, r);
  var c,
    u,
    s,
...
if (
  ...
  for (en in vn) s[en] && It(s[en], un);
if ((!hn || !sn || sn === fn) && ((sn = un.prototype), hn))
  for (en in vn) s[en] && It(s[en].prototype, sn);
  ...
  Pn = (function(e, t) {
    ...
    return (jn[e] =
      ...
      !f(function() {
        if (r && !l) return !0;
        var e = { length: -1 };
        r ? An(e, 1, { enumerable: !0, get: In }) : (e[1] = 1), n.call(e, o, i);
      }));
