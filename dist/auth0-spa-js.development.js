        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, getJSON(baseUrl + "/oauth/token", {
                        method: 'POST',
                        body: JSON.stringify(__assign({ grant_type: 'authorization_code', redirect_uri: window.location.origin, client_secret: '5AH8Uzg-oTFd9kvwUDp8VAEfVWF5og2_p2H1dgY-cEJTOcx63jpjtrNugrdWY0_u' }, options)),
                        headers: {
