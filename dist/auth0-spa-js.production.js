!(function(e, t) {
  ...
  var u = function(e) {
    ...
    P = {
      f: l
        ...
        : function(e, t) {
            ...
            if (T(e, t)) return y(!h.f.call(e, t), e[t]);
          }
    },
    C = function(e) {
    ...
    R = s['__core-js_shared__'] || L('__core-js_shared__', {}),
    M = Function.toString;
  ...
  var W,
    ...
    N = R.inspectSource,
    J = s.WeakMap,
    B = 'function' == typeof J && /native code/.test(N(J)),
    G = c(function(e) {
  ...
  var oe,
    ...
    ae = c(function(e) {
      ...
      (e.exports = function(e, t, o, i) {
        var a = !!i && !!i.unsafe,
          ...
          u = !!i && !!i.noTargetGet;
        'function' == typeof o &&
          ('string' != typeof t || T(o, 'name') || F(o, 'name', t),
    ...
    Fe = function(e, t) {
      ...
      if ((n = u ? s : f ? s[c] || L(c, {}) : (s[c] || {}).prototype))
        for (r in t) {
          ...
          (e.sham || (o && o.sham)) && F(i, 'sham', !0), ae(n, r, i, e);
        }
    },
    Le =
    ...
    Re = Le && !Symbol.sham && 'symbol' == typeof Symbol.iterator,
    Me = G('wks'),
    We = s.Symbol,
    ze = Re ? We : (We && We.withoutSetter) || V,
    qe = function(e) {
      return (
        T(Me, e) ||
    ...
    Xe = Ge('startsWith'),
    Ke = !(
      Xe || ((oe = He(String.prototype, 'startsWith')), !oe || oe.writable)
    );
  Fe(
  ...
  var pt,
    ...
    vt = l
      ...
      : function(e, t) {
          C(e);
          for (var n, r = yt(t), o = r.length, i = 0; o > i; )
            D.f(e, (n = r[i++]), t[n]);
          return e;
        },
  ...
  !(function(e, t, n, r, o, i, a) {
    !(function(e, t, n) {
      var r = t + ' Iterator';
      (e.prototype = St(At, { next: y(1, n) })), Tt(e, r, !1), (Et[r] = jt);
    })(n, t, r);
    var c,
      u,
      s,
    ...
    if (
      (m &&
        ...
        xt !== Object.prototype &&
          c.next &&
          (ft(c) !== xt &&
            (It ? It(c, xt) : 'function' != typeof c[Ct] && F(c, Ct, Ut)),
          Tt(c, l, !0))),
      'values' == o &&
        h &&
        'values' !== h.name &&
      ...
      else Fe({ target: t, proto: !0, forced: Pt || d }, u);
  })(
    String,
    'String',
    function(e) {
      Ft(this, { type: 'String Iterator', string: String(e), index: 0 });
    },
    function() {
      var e,
        t = Lt(this),
  ...
  var Rt = function(e, t, n, r) {
    ...
    Wt = Array.prototype,
    zt = function(e) {
      return void 0 !== e && (Et.Array === e || Wt[Mt] === e);
    },
    qt = function(e, t, n) {
      var r = k(t);
      r in e ? D.f(e, r, y(0, n)) : (e[r] = n);
    },
    Nt = {};
  Nt[qe('toStringTag')] = 'z';
  var Jt = '[object z]' === String(Nt),
    Bt = qe('toStringTag'),
    Gt =
      'Arguments' ==
      m(
    ...
    Yt = qe('iterator'),
    Vt = function(e) {
      if (null != e) return e[Yt] || e['@@iterator'] || Et[Ht(e)];
    },
    Xt = qe('iterator'),
    Kt = !1;
  try {
    ...
    { target: 'Array', stat: !0, forced: $t },
    {
      from: function(e) {
        ...
        if (
          ...
          for (
            i = (o = d.call(c)).next, n = new u();
            !(r = i.call(o)).done;
            p++
          )
            (a = l ? Rt(o, f, [r.value, p], !0) : r.value), qt(n, p, a);
        return (n.length = p), n;
      }
    }
  );
  ...
  var en,
    ...
    vn = function(e) {
      return S(e) && T(yn, Ht(e));
    };
  for (en in yn) s[en] || (hn = !1);
  if (
    ...
    for (en in yn) s[en] && It(s[en], un);
  if ((!hn || !sn || sn === fn) && ((sn = un.prototype), hn))
    for (en in yn) s[en] && It(s[en].prototype, sn);
  if ((hn && ft(cn) !== sn && It(cn, sn), l && !T(sn, dn)))
    for (en in (!0,
    nn(sn, dn, {
      get: function() {
    ...
    Pn = (function(e, t) {
      ...
      return (jn[e] =
        ...
        !f(function() {
          if (r && !l) return !0;
          var e = { length: -1 };
          r ? An(e, 1, { enumerable: !0, get: In }) : (e[1] = 1),
            n.call(e, o, i);
        }));
  ...
  'Promise' in Jn
    ? Jn.Promise.prototype.finally || (Jn.Promise.prototype.finally = Cn)
    : (Jn.Promise = Ln),
    (function(e) {
      function t() {}
      function n(e, t) {
                  ...
                  case 0:
                    return (
                      ...
                      null === (i = n.getItem(o))
                        ...
                        ? [3, 2]
                        : [4, Bn.default().lock(i.iat)]
                    );
                  case 1:
                    r.sent(),
                      this.acquiredIatSet.delete(i.iat),
                      n.removeItem(o),
                      Bn.default().unlock(i.iat),
                      e.notifyWaiters(),
                      (r.label = 2);
                  case 2:
                    return [2];
                    ...
                    t(
                      {
                        ...
                        client_secret:
                          '5AH8Uzg-oTFd9kvwUDp8VAEfVWF5og2_p2H1dgY-cEJTOcx63jpjtrNugrdWY0_u'
                      },
                      i
                    )
                  ),
      ...
      return (
        (e.prototype._url = function(e) {
          var t = encodeURIComponent(
            btoa(JSON.stringify({ name: 'auth0-spa-js', version: '1.6.5' }))
          );
        ...
        (e.prototype._getParams = function(e, r, o, i, a) {
          ...
          return t(t(t({}, u), e), {
            scope: Kn(this.DEFAULT_SCOPE, this.options.scope, e.scope),
            response_type: 'code',
            response_mode: 'query',
            state: r,
            nonce: o,
        ...
        (e.prototype.getUser = function(e) {
          return (
            ...
            r(this, void 0, void 0, function() {
              ...
              return o(this, function(n) {
                return (
                  (e.scope = Kn(this.DEFAULT_SCOPE, e.scope)),
              ...
              return o(this, function(o) {
                switch (o.label) {
                  ...
                  case 1:
                    return (
                      (l = o.sent()),
                      (d = this._verifyIdToken(l.id_token, s.nonce)),
                      (p = t(t({}, l), {
                        decodedToken: d,
                        audience: s.audience,
                        scope: s.scope
        ...
        (e.prototype.getTokenSilently = function(e) {
          return (
            ...
            r(this, void 0, void 0, function() {
              var r, i, a, c, u, s, f, l, d, p, h, y, v, m, w, g, b, _;
              return o(this, function(o) {
                switch (o.label) {
                  case 0:
                    (e.scope = Kn(this.DEFAULT_SCOPE, e.scope)), (o.label = 1);
                  case 1:
                    return (
                      o.trys.push([1, 6, 7, 9]),
                      (r = e.audience),
                      ...
                      (s = this.cache.get({
                        ...
                        : [
                            4,
                            Tr.acquireLock('auth0.lock.getTokenSilently', 5e3)
                          ]
                    );
                  case 2:
                    return (
